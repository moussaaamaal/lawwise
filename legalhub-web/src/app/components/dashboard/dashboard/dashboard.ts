...
export class Dashboard implements AfterViewInit {
  ...
  hearings = [
    ...
    { month: 'Nov', day: '20', title: 'Thompson Real Estate Deal', location: 'Contract Signing - Office Meeting', badge: 'In 5 days', badgeColor: 'bg-blue-500', cardColor: 'bg-blue-50 border-blue-200', dateBg: 'bg-blue-100', dotColor: 'text-blue-500', dayColor: 'text-blue-700', time: '11:00 AM', user: 'Michael Chen', type: 'Real Estate' },
  ...
  tasks = [
    ...
    { title: 'Prepare contract amendments', desc: 'Draft revised contract terms', case: 'Thompson Real Estate', avatar: 'https://storage.googleapis.com/uxpilot-auth.appspot.com/avatars/avatar-3.jpg', assignee: 'Michael Chen', priority: 'Low', priorityColor: 'bg-green-100 text-green-700', dueDate: 'Nov 18, 2024', dueNote: 'In 3 days', dueNoteColor: 'text-gray-600', status: 'In Progress', statusColor: 'bg-amber-100 text-amber-700' },
